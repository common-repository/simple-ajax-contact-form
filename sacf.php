...
function sacf_display_form()
{
	...
	$sacf_test = '<div style="width:'.$sacf_options['form_size'].'px; float:left">
								<form id="scf-form" action="" method="POST">
									...
									<input type="text" name="scf-name" class="txt" id="scf-name" /><div class="sacf_clear"></div>
																		
									<label>';
									if($sacf_options['phone_req'] == '1')
									{
										$sacf_test .= '<b>*</b>';
									}
									$sacf_test .=  __('Telephone','sacf') .'</label>
									<input type="text" name="scf-phone" class="txt" id="scf-phone" /><div class="sacf_clear"></div>
									
									<label><b>*</b>'. __('E-Mail','sacf') .'</label>
									<input type="text" name="scf-email" class="txt" id="scf-email" /><div class="sacf_clear"></div>';
									...
									if($sacf_options['subject'] == '1')
									{
										...
										$sacf_test .= __('Subject','sacf') .'</label>
																	<input type="text" name="scf-subject" class="txt" id="scf-subject" /><div class="sacf_clear"></div>';
									}
									
		$sacf_test .= '<label><b>*</b>'. __('Comment','sacf') .'</label>
									<textarea id="scf-comment" name="scf-comment" class="txtarea" ></textarea><div class="sacf_clear"></div>';
